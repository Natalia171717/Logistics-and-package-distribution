...
que res sea en todos efectivamente la lista de los n traslados más antiguos, claramente.
*/
    @BeforeEach
    public void init() {
        ...
        traslados[4] = new Traslado(5, 4, 6, 2900, 2020);
    ...
    public void testNestaEnRango() {
        assertArrayEquals(new int[]{10, 9, 8, 7}, sistema.despacharMasAntiguos(4), "Despacho los 4 más antiguos. Espero obtener la siguiente lista de ids: [6, 5, 4, 1]");
    }

    @Test
    public void testNesCero() {
        assertArrayEquals(new int[]{}, sistema.despacharMasAntiguos(0), "Despacho los 0 más redituables. Espero obtener la siguiente lista de ids: []");
    }

    @Test
    public void testNesMayorALongitudTraslados() {
        assertArrayEquals(new int[]{10, 9,8,7,6,4,5,3,2,1}, sistema.despacharMasAntiguos(89), "Despacho toda la lista. ¿Que pasa si coinciden las fechas");
    }

    @Test
    public void testNesIgualALongitudTraslados() {
        assertArrayEquals(new int[]{10, 9,8,7,6,4,5,3,2,1}, sistema.despacharMasAntiguos(10), "Despacho toda la lista porque la cantidad que me piden es su longitud");
    }

    @Test
    public void testTrasladosVacios() {
        sistema.despacharMasAntiguos(10); 
        assertArrayEquals(new int[]{}, sistema.despacharMasAntiguos(3), "No hay nada que despachar. Espero obtener la siguiente lista de ids: []");
    }
}
